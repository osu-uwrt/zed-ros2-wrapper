...
protected:
  ...
  void publishNormals(sl::Mat & normals, rclcpp::Time t);
...
private:
  ...
  camInfoMsgPtr mNormalsCamInfoMsg;
  // <---- Messages
  ...
  image_transport::CameraPublisher mPubNormals;
